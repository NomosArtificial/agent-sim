from components.prompts_library import INPUT_PROMPT, REFLECT_USER_PROMPT, REFLECT_SYSTEM_PROMPT
...
class Agent:
    ...
    """
    def __init__(self, respond_model: Callable, reflect_model: Callable, inception_prompt: str, role_name: str) -> None:
        """
    ...
    def reflect(self) -> None:
        ...
        if self.memory_length >= 1000:
            ...
            processed_messages = self.reflect_model(REFLECT_SYSTEM_PROMPT, REFLECT_USER_PROMPT.format(messages_to_process))
